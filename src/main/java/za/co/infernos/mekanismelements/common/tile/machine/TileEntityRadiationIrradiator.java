...
import za.co.infernos.mekanismelements.api.recipes.cache.RadiationIrradiatingCachedRecipe;
...
public class TileEntityRadiationIrradiator extends MSTileEntityProgressMachine<RadiationIrradiatingRecipe> implements
    ...
    protected boolean onUpdateServer() {
        ...
        if (level.getGameTime() % 40 == 0) {
             za.co.infernos.mekanismelements.common.MekanismElements.logger.info("DEBUG: RadiationIrradiator Tick | Energy: {}/{} | InputItem: {} | InputChemical: {} | Output: {} | Active: {}", 
